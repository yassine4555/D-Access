...
interface CommentSubmittedPopupProps {
  visible: boolean;
  onClose: () => void;
}
...
export function CommentSubmittedPopup({ visible, onClose }: CommentSubmittedPopupProps) {
  return (
      ...
      <View style={styles.overlay}>
        <View style={styles.card}>
          <View style={styles.contentWrap}>
            ...
            <Text style={styles.title}>Comment Submitted</Text>
